...
-- 4. 클라이언트 – 프리랜서/에이전시
(NULL, 'ROLE_PLAY', '클라이언트 – 프리랜서/에이전시', 'WORK_COMPANY',
...
-- 5. 세일즈/CS 직원 – 고객
(NULL, 'ROLE_PLAY', '세일즈/CS 직원 – 고객', 'WORK_COMPANY',
...
-- 6. 상사 – 부하직원
(NULL, 'ROLE_PLAY', '상사 – 부하직원', 'WORK_COMPANY',
...
-- 1. 친한 친구 1, 2
(NULL, 'ROLE_PLAY', '친한 친구 1, 2', 'RELATION_EMOTION',
...
(NULL, 'ROLE_PLAY', '사과 상황: 잘못한 사람 – 서운한 사람', 'RELATION_EMOTION',
