...
public class ApiV1ChatController implements ApiChat {
    ...
    public ApiResponse<MessageResp> sendMessage(Long roomId, CustomUserDetails currentUser, TextMessageReq request) {
