...
public interface ChatApi {
    ...
    ApiResponse<ChatRoomResp> createGroupRoom(
            @Parameter(hidden = true) @AuthenticationPrincipal CustomUserDetails currentUser,
    ...
    ApiResponse<ChatRoomResp> createPublicGroupRoom(
            @Parameter(hidden = true) @AuthenticationPrincipal CustomUserDetails currentUser,
    ...
    ApiResponse<List<MessageResp>> getMessages(
    ...
    ApiResponse<MessageResp> uploadFile(
